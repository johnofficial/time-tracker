...
class s_events(base.common.orm.sql_base):
    __tablename__ = 's_events'
...
class s_event_tasks(base.common.orm.sql_base):
    __tablename__ = 's_event_tasks'
...
def main():
    ...
    for _s in [
        ...
        ('t', '00', '000', 4, 0, 'event_tasks', 'STR', 's_event_tasks', False),
        ('e', '00', '000', 4, 0, 'events', 'STR', 's_events', False)]:
        _seq = Sequencer(*_s)
